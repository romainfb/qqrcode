...
function CanvasExport({ backgroundColor, cornersStyle }: CanvasExportProps) {
  const getCanvas = () => document.querySelector('#qr-container canvas') as HTMLCanvasElement | null
  ...
  const composeWithBackground = (qrCanvas: HTMLCanvasElement) => {
